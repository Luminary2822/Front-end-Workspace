...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            // 把该类型（word,ppt等类型的文件缩略图显示成一张图片）
            tObject = '<img data="{data}"  src="../images/icon_file.png" class="file-preview-image kv-preview-data" title="{caption}" ' +
                'alt="{caption}"' +  'style="margin-top:5%;width: 80%;height: 75%;"' + '>\n';
        ...
        _uploadSingle: function (i, isBatch) {
            ...
            self._ajaxSubmit(fnBefore, fnSuccess, fnComplete, fnError, previewId, i.true);
        },
